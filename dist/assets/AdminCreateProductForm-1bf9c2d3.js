 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wr(t){se(new J("platform-logger",e=>new rr(e),"PRIVATE")),se(new J("heartbeat",e=>new Hr(e),"PRIVATE")),z(_e,je,t),z(_e,je,"esm2017"),z("fire-js","")}Wr("");var Gr="firebase",Kr="9.19.1";/**
 * @license
