...
describe("Testing CheckOutStep1_part1Desktop component", () => {
  test("CheckOutStep1_part1Desktop renders correctly.", () => {
...
describe("Testing CheckOutStep1_part1Desktop error handling", () => {
  test("The CheckOutStep1_part1Desktop error handles first name form correctly.", async () => {
  ...
  test("The CheckOutStep1_part1Desktop error handles last name form correctly.", async () => {
    const user = userEvent.setup();
    render(<CheckOutPageDesktop />);
    // grab continue button
    const Step1_Part1ContinueButton = screen.getByRole("button", {
  ...
  test("The CheckOutStep1_part1Desktop error handles email form correctly.", async () => {
    const user = userEvent.setup();
    render(<CheckOutPageDesktop />);
    // grab continue button
    const Step1_Part1ContinueButton = screen.getByRole("button", {
  ...
  test("The CheckOutStep1_part1Desktop handles phone form correctly.", async () => {
    const user = userEvent.setup();
    render(<CheckOutPageDesktop />);
    // grab continue button
    const Step1_Part1ContinueButton = screen.getByRole("button", {
  ...
  test("The CheckOutStep1_part1Desktop goes to the next step if data is correct.", async () => {
    const user = userEvent.setup();
    render(<CheckOutPageDesktop />);
