...
describe("Testing CheckOutStep1_Part2 component", () => {
  test("CheckOutStep1_Part2 renders correctly", () => {
    /* eslint-disable */
    render(<CheckOutStep1_Part2 />);
    /* eslint-enable */
  ...
  test("CheckoutPart1_Part2 functionality works", async () => {
...
describe("Test Step1_Part2 error handles correctly", () => {
  test("CheckOutStep1_Part2 error handles Address Line 1 form", async () => {
    const user = userEvent.setup();
    /* eslint-disable */
    render(<CheckOutStep1_Part2 />);
    /* eslint-enable */
  ...
  test("CheckOutStep1_Part2 error handles Address Line 2 form", async () => {
    const user = userEvent.setup();
    /* eslint-disable */
    render(<CheckOutStep1_Part2 />);
    /* eslint-enable */
  ...
  test("CheckOutStep1_Part2 error handles City form", async () => {
    const user = userEvent.setup();
    /* eslint-disable */
    render(<CheckOutStep1_Part2 />);
    /* eslint-enable */
  ...
  test("CheckOutStep1_Part2 error handles Post Code form", async () => {
    const user = userEvent.setup();
    /* eslint-disable */
    render(<CheckOutStep1_Part2 />);
    /* eslint-enable */
  ...
  test("CheckOutStep1_Part2 error handles Country form", async () => {
    const user = userEvent.setup();
    /* eslint-disable */
    render(<CheckOutStep1_Part2 />);
    /* eslint-enable */
